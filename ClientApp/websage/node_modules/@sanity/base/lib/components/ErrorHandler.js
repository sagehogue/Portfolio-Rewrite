...
class ErrorHandler extends _react.default.PureComponent {
  ...
  render() {
    ...
    return _react.default.createElement(_default.default, {
      ...
      className: _ErrorHandler.default.errorMessageHeader
    }, _react.default.createElement("strong", null, message)), _react.default.createElement("div", null, "Check browser javascript console for details"));
  }
