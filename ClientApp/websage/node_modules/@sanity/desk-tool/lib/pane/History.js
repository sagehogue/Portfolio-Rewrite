...
var _History = _interopRequireDefault(require("./styles/History.css"));
...
class History extends _react.default.PureComponent {
  ...
  componentDidUpdate(prevProps) {
    var _this$props = this.props,
        selectedRev = _this$props.selectedRev,
        events = _this$props.events,
        historyValue = _this$props.historyValue;
  ...
  render() {
    ...
    }, "History", _react.default.createElement(_default.default, {
      onClick: onClose,
      title: "Close",
    ...
    }), error && _react.default.createElement("p", null, "Could not load history"), _react.default.createElement("div", {
      className: _History.default.list,
      ref: this._listElement
    }, !(isLoading || error) && events.map((event, i) => _react.default.createElement(_HistoryItem.default, _extends({}, event, {
      key: event.rev,
    ...
    })))), error && _react.default.createElement(_default2.default, {
      kind: "danger",
      timeout: 3
    }, error));
  }
