...
_temp = _class = class Editor extends _react.default.PureComponent {
  constructor() {
    ...
    _defineProperty(this, "handleConfirmHistoryRestore", () => {
      ...
      if (selectedEvent) {
        _history.default.getDocumentAtRevision(selectedEvent.displayDocumentId, selectedEvent.rev).then(document => {
          onRestore(document);
    ...
    _defineProperty(this, "renderPublishInfo", () => {
      var _this$props5 = this.props,
          ...
          isRestoring = _this$props5.isRestoring,
      ...
      return _react.default.createElement(_react.default.Fragment, null, (isCreatingDraft || isPublishing || isUnpublishing || isRestoring) && _react.default.createElement("div", {
      ...
      }), isRestoring && _react.default.createElement(_spinner.default, {
        center: true,
    ...
    _defineProperty(this, "renderHistoryInfo", () => {
      var isReconnecting = this.props.isReconnecting;
      var historyState = this.state.historyState;
      var selectedEvent = this.findSelectedEvent();
      var isLatestEvent = historyState.events[0] === selectedEvent;
      return _react.default.createElement(_RestoreHistoryButton.default, {
    ...
    _defineProperty(this, "renderStaticContent", () => {
      ...
      return _react.default.createElement("div", {
        className: (draft || this.state.historyState.isOpen) && !this.isLiveEditEnabled() ? _Editor.default.publishInfo : _Editor.default.publishInfoHidden
      }, this.state.historyState.isOpen && this.renderHistoryInfo(), !this.state.historyState.isOpen && draft && this.renderPublishInfo());
    });
  ...
  renderForm() {
    var _this$props9 = this.props,
        ...
        draft = _this$props9.draft,
        published = _this$props9.published,
        patchChannel = _this$props9.patchChannel;
  ...
  render() {
    ...
    return _react.default.createElement("div", {
      ...
      kind: "success",
      timeout: 4 // eslint-disable-next-line react/jsx-no-bind
      ,
