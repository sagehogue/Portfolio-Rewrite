        ...
        return (
            <PageModal displayed={"portfolio"}>
                <div className={wrapperClassList.join(' ')}>
                    ...
                    <PortfolioItem label="Volunteer Work" position={3} stateHandler={this.displayItem}>
                        <section>
                            <p>Women's Crisis Center IT work</p>
                        </section>
                    </PortfolioItem>
                    <PortfolioItem label="Work Experience" position={4} stateHandler={this.displayItem}>
                        <section>
